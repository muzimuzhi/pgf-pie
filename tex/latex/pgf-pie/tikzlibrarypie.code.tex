...
\def\pgfpie@slice#1#2#3#4#5#6#7#8{%
  ...
  \pgfpie@ifx\pgfpie@text\pgfpie@text@inside{%
    ...
    {\pgfpie@scalefont{#3}\pgfpie@labelandnumbertext{#4}{#3}};
  }{%
    % label
    \pgfpie@ifhidelabel{}{%
      \pgfpie@iflegend{}{%
...
\def\pgfpie@square#1#2#3#4#5{%
  \pgfpie@ifx\pgfpie@text\pgfpie@text@inside{%
    ...
    {\pgfpie@scalefont{#3}\pgfpie@labelandnumbertext{#5}{#3}} ++(#2);
  }{%
...
\def\pgfpie@cloud#1#2#3#4#5#6{%
  ...
  \pgfpie@ifx\pgfpie@text\pgfpie@text@inside{%
    \node[align=center] at (#1) {\pgfpie@scalefont{#3}\pgfpie@labelandnumbertext{#6}{#3}};
  }{%
...
\def\pgfpie@numbertext#1{\pgfpie@numbertext@{}{#1}}
\def\pgfpie@numbertext@#1#2{%
  \pgfpie@ifhidenumber{}{%
    #1% empty or \\
    \pgfpie@beforenumber#2\pgfpie@afternumber
  }%
}

\pgfpie@newif{hidelabel}
\pgfqkeys{/pgfpie}{hide label/.is if=pgfpie@hidelabel}
\def\pgfpie@labelandnumbertext#1#2{%
  \pgfpie@ifhidelabel{%
    \pgfpie@numbertext@{}{#2}%
  }{%
    #1%
