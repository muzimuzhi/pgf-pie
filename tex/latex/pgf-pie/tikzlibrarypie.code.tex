...
\def\pgfpie@newif#1{%
  \expandafter\newif\csname ifpgfpie@#1\endcsname
...
\def\pgfpie@slice#1#2#3#4#5#6#7#8{%
  ...
  \pgfpie@ifx\pgfpie@text\pgfpie@text@inside{%
    ...
    {\pgfpie@scalefont{#3}\shortstack{#4\\\pgfpie@numbertext{#3}}};
  }{%
    % label
    \pgfpie@iflegend{}{%
...
\def\pgfpie@square#1#2#3#4#5{%
  \pgfpie@ifx\pgfpie@text\pgfpie@text@inside{%
    ...
    {\pgfpie@scalefont{#3}\shortstack{#5\\\pgfpie@numbertext{#3}}} ++(#2);
  }{%
    \draw[fill={#4},\pgfpie@style] (#1) rectangle node
...
\def\pgfpie@cloud#1#2#3#4#5#6{%
  ...
  \pgfpie@ifx\pgfpie@text\pgfpie@text@inside{%
    \node at (#1) {\pgfpie@scalefont{#3}\shortstack{#6\\\pgfpie@numbertext{#3}}};
  }{%
...
\def\pgfpie@pie@circle#1{%
  \pgfpie@ifpolar{%
    ...
    \foreach \p/\e in {#1} {
      \pgfpie@ifnum{\pgfpie@maxValue}{<}{\p}{%
